...
namespace Roadkill.Tests.Unit.Text.Parsers.Markdig
{
    public class MarkdigImageAndLinkWalkerTests
    {
        ...
        public void should_add_alt_attribute_and_bootstrap_class_and_border_attribute()
        {
            ...
            // then
            Assert.That(html, Is.EqualTo("<p><img src=\"meme.jpg\" class=\"img-responsive\" border=\"0\" alt=\"my image\" title=\"my image\" /></p>\n"));
        }
        ...
        public void should_change_url_and_title_from_handler()
        {
            ...
            // then
            Assert.That(html, Is.EqualTo("<p><img src=\"new-image.jpg\" class=\"img-responsive\" border=\"0\" alt=\"new-alt\" title=\"new-title\" /></p>\n"));
        }
